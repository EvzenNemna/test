        ...
        <div class="content">
            <h2>HireMe</h3>
                <div class="navbar">
                    ...
                    <a class="login-trigger" href="signup.html" data-target="#login" data-toggle="modal">Login</a>
                    <ul>
    ...
    <main>
        ...
        <form name="form" action="register.php"  method="post" enctype="multipart/form-data">
            <div class="accountSide">
                <label for="username">Username: <br><input type="text" name="username"></label>
                <label for="email">E-Mail: <br><input type="email" name="email"></label>
                <label for="username">Password: <br><input type="password" name="password"></label>
            </div> 
            <div class="profileSide">
            <label for="fullname">Fullname: <br><input type="text" name="fullname"></label>
            <label for="aboutme">About me: <br><textarea name="aboutme" cols="30" rows="10" style="resize:none"></textarea></label>
            <label for="price">My price for €/Hour: <br><input type="number" name="price"></label>
            <label for="pfp">Profile picture:<br>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4 mb-lg-0"><img src="img/logo.png" alt="" width="180" class="mb-3">
                        ...
                        <ul class="list-inline mt-4">
                            <li class="list-inline-item"><a href="#" target="_blank" title="twitter"><i
                                        class="fa fa-twitter" style="color:black; font-size: 25px;"></i></a></li>
                            <li class="list-inline-item"><a href="#" target="_blank" title="facebook"><i
                                        class="fa fa-facebook" style="color:black; font-size: 25px;"></i></a></li>
                            <li class="list-inline-item"><a href="#" target="_blank" title="instagram"><i
                                        class="fa fa-instagram" style="color:black; font-size: 25px;"></i></a></li>
                        </ul>
                    </div>
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form>
                                ...
                                <br>
                                <a href="#" class="text-muted">[SignUp_text]</a>
                            </form>
                        </div>
                    </div>
                </div>
